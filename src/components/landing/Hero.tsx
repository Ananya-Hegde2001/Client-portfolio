        ...
        <Container className="relative z-10 rounded-2xl border p-6 sm:p-8 md-6 pt-14 sm:pt-12 bg-white/60 border-black/8 dark:bg-white/2 dark:border-white/8 opacity-100 transform-none mx-auto max-w-3xl">
            <div className="mb-4">
                <div className="flex items-center gap-2 flex-wrap">
                    <h1 className="font-space-grotesk text-xl sm:text-2xl font-semibold text-foreground">Sapana Dashoni</h1>
                    <Image
                        src={badge}
                        alt="badge"
                        width={24}
            ...
            <p className="text-sm sm:text-base text-foreground/70 leading-relaxed mb-5 sm:mb-6">
                I love starting from a blank slate and turning it into a finished product. From frontend and backend to deployment, I build software that&apos;s practical, usable, and reliable. Amazon MLSS&apos;25 Scholar | Grace Hopper Celebration&apos;24 Scholar | Open Source Contributor.            </p>
            <div className="flex flex-wrap gap-2 sm:gap-3 mb-5 sm:mb-6">
                <Button
                    asChild
                    variant={'outline'}
                    className="px-4 sm:px-5 py-3 sm:py-2.5 text-xs sm:text-xs font-medium transition-all duration-300 ease-in-out hover:scale-105"
                >
                    <Link href={`/resume`}>
                        <CV />
                        Resume / CV
                ...
                <Button
                    asChild
                    variant={'default'}
                    className="px-4 sm:px-5 py-3 sm:py-2.5 text-xs sm:text-xs font-medium main-button transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 dark:text-white"
                >
